...
def make_shapenet(config):
  """Creates the Shapenet dataset."""
  ...
  res = AttrDict(
      trainset=image.create(
          'shapenet', subset='train', batch_size=batch_size, transforms=transform),
      validset=image.create(
          'shapenet', subset='test', batch_size=batch_size, transforms=transform))
